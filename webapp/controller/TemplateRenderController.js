sap.ui.define([
	...
	"com/evorait/evosuite/evoprep/model/AnnotationHelper",
	"sap/ui/core/mvc/OverrideExecution"
], function (BaseController, Controller, CoreView, ViewType, AnnotationHelper, OverrideExecution) {
	"use strict";

	return BaseController.extend("com.evorait.evosuite.evoprep.controller.TemplateRenderController", {
			...
			if (aContent.length === 0) {
				if (this.mTemplates[sViewName]) {
					...
					oMetaModel.loaded().then(function () {
						...
						if (sControllerName) {
							Controller.create({
								name: "com.evorait.evosuite.evoprep.controller." + sControllerName
		...
		bindView: function (oView, sPath, callbackFn) {
			...
			if (!sPath) {
				eventBus.publish("TemplateRendererEvoPrep", "changedBinding", {
